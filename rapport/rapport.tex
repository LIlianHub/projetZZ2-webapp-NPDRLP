...
{
	name=SCSS,
	description={Le SCSS est une surcouche du CSS qui est un langage informatique utilisé sur Internet pour la mise en forme de fichiers et de pages HTML. On le traduit en français par feuilles de style en cascade.
	}
}
...
{
	name=Web scraping,
	description={Le Web scraping (parfois appelé harvesting ou en français moissonage1) est une technique d'extraction du contenu de sites Web, via un script ou un programme, dans le but de le transformer pour permettre son utilisation dans un autre contexte comme l'enrichissement de bases de données, le référencement2 ou l'exploration de données.
	}
}
